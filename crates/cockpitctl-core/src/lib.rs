...
pub use cockpitctl_ports as ports;
...
pub use cockpitctl_ingest::{IngestRequest, IngestResult, IngestUseCase};

// Flatten the most-used ports.
pub use cockpitctl_ports::{
    NoOpSchemaValidator, OutputSink, PolicySource, ReceiptSource, SchemaValidator,
};
