...
pub use cockpitctl_ingest::IngestUseCase;

// Flatten shared port contracts.
pub use cockpitctl_ports::{
    IngestRequest, IngestResult, NoOpSchemaValidator, OutputSink, PolicySource, ReceiptSource,
    SchemaValidator,
};
