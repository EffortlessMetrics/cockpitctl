...
pub use cockpitctl_render_annotations::{AnnotationRenderResult, GitHubAnnotationResult};
...
pub fn render_annotations(
    ...
    cockpitctl_render_annotations::render_annotations(highlights, cfg, sensor_blocking)
}
...
pub fn render_github_annotations(
    ...
    cockpitctl_render_annotations::render_github_annotations(highlights, cfg, sensor_blocking)
}
