...
pub use cockpitctl_render_annotations::{
    AnnotationRenderResult, GitHubAnnotationResult, render_annotations, render_annotations_section,
    render_github_annotations,
};
use cockpitctl_types::{
    BuildfixApplyStatus, BuildfixApplySummary, BuildfixSummary, CockpitConfig, CockpitReport,
    PolicySignatureAlgorithm, PolicySignatureEvidence, SafetyLevel, Severity, TrendDelta,
    VerdictStatus,
};
...
// Annotation rendering lives in `cockpitctl-render-annotations` and is re-exported here.
...
mod tests {
    use super::*;
    use cockpitctl_types::{Finding, Highlight, Location, Severity};
