<h1 align="center">cockpitctl</h1>

<p align="center">
  <a href="https://github.com/EffortlessMetrics/cockpitctl/actions/workflows/ci.yml"><img src="https://github.com/EffortlessMetrics/cockpitctl/actions/workflows/ci.yml/badge.svg?branch=main" alt="CI" /></a>
  <a href="https://codecov.io/gh/EffortlessMetrics/cockpitctl"><img src="https://codecov.io/gh/EffortlessMetrics/cockpitctl/graph/badge.svg?branch=main" alt="Codecov" /></a>
  <a href="https://github.com/EffortlessMetrics/ripr/blob/main/docs/BADGE_POLICY.md"><img src="https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/EffortlessMetrics/cockpitctl/main/badges/ripr-plus.json" alt="ripr+" /></a>
</p>

<p align="center">
  <a href="https://github.com/EffortlessMetrics/cockpitctl/releases"><img src="https://img.shields.io/github/v/release/EffortlessMetrics/cockpitctl?sort=semver&label=release" alt="GitHub release" /></a>
  <a href="https://crates.io/crates/cockpitctl"><img src="https://img.shields.io/crates/d/cockpitctl.svg?label=crates.io%20downloads" alt="crates.io downloads" /></a>
  <a href="https://docs.rs/cockpitctl"><img src="https://docs.rs/cockpitctl/badge.svg" alt="docs.rs" /></a>
</p>
...
<p align="center">
  <em>Offline CI director that compiles sensor receipts into deterministic merge evidence.</em>
</p>
